...
# 為 LineIDAnalyzer 增加一個由標題、作者暱稱、及內文分析文字作者性別、年紀、居住地區、興趣的功能
    * 性別
        + 男性
        + 女性
        + 無法分析
...
> 台灣人提到年紀時，如果寫的是 XX 年次，代表的是出生年為 1911 年再加上 XX ，例如 73 年次，代表 1984 年出生。目前會推論錯誤。

> 分析作者 profile 時，若標題部份有類似 "徵男" "徵女" 之類的文字，而內文又沒有自陳、或可推測出作者性別的，則可推論
    * 徵男者為女性
    * 徵女者為男性